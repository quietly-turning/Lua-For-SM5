	...
	render() {
		return (
			<div>
				...
				<p>
					StepMania 5&apos;s complete API documentation can be found in its Lua.xml file, which ships with releases of StepMania 5 in the <samp>./Docs/Luadoc/</samp> directory and can be viewed in most web browsers. I have also hosted a copy as part of this website: <a href="/Lua-For-SM5/API/Lua.xml">Lua For SM5: Lua API</a>.
				</p>
				<p>
