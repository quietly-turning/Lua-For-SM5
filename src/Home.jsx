	...
	render() {
		return (
			<div>
				...
				<p>
					The closest thing to proper API documentation that SM5 currently has is its Lua.xml file, which comes with StepMania 5 in the <samp>./Docs/Luadoc/</samp> directory and can be viewed in most web browsers. I have also hosted a copy as part of this website: <a href="/Lua-For-SM5/API/Lua.xml">Lua For SM5: Lua API</a>.
				</p>
				<p>
